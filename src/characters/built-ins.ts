...
export const cleiraOestwilde: Character = {
  ...
  attacks: [
    { id: "rapier", name: "Rapier", kind: "melee", attackBonus: 4, damage: "1d8 + 2 piercing", normalRangeFeet: 5, description: "Martial, finesse, Vex.", masteryOwnership: "not-granted" },
  ...
  spells: [
    ...
    { id: "charm-person", name: "Charm Person", level: 1, castingTime: "action", rangeFeet: 30, target: "single", targetSide: "any", requiresLineOfSight: true, save: { ability: "wisdom", dc: 12, damageOnSuccess: "none" }, targetCreatureTypes: ["humanoid"], hostileSaveAdvantage: true, durationRounds: 600, description: "A humanoid target makes a DC 12 Wisdom save with advantage while fighting the caster or an ally. On a failure, it is charmed for 1 hour or until harmed by the caster or an ally.", effect: { name: "Charm Person", description: "The target is charmed by the caster, regards the caster as friendly, and grants the caster Advantage on social interaction checks until the spell ends.", conditionGranted: "charmed", modifiers: { preventsHarmingSource: true }, endsWhenSourceHarmsTarget: true, revealsSourceOnEnd: true, socialInteractionAdvantageForSource: true, targetFriendlyToSource: true }, provenance: { rulesetId: "dnd-2014", sourceId: "srd-5.1", sourceReference: "SRD 5.1, Charm Person and Charmed condition" } },
    { id: "detect-magic", name: "Detect Magic", level: 1, school: "divination", castingTime: "action", rangeFeet: 0, target: "self", requiresLineOfSight: false, ritual: true, concentration: true, durationRounds: 100, description: "Senses registered magic within 30 feet and supports a Magic Action to reveal visible auras and spell schools. Before initiative, it can be cast as a ten-minute ritual without a slot.", provenance: { rulesetId: "dnd-2024", sourceId: "srd-5.2.1", sourceReference: "SRD 5.2.1, Detect Magic, p. 122" }, effect: { name: "Detect Magic", description: "Cleira senses whether registered magic is present within 30 feet.", senseMagic: { rangeFeet: 30, blockedByTotalCover: true } } },
    ...
    { id: "thunderwave", name: "Thunderwave", level: 1, school: "evocation", castingTime: "action", rangeFeet: 0, target: "area", targetSide: "hostile", requiresLineOfSight: false, damage: "2d8 thunder", save: { ability: "constitution", dc: 12, damageOnSuccess: "half" }, area: { origin: "self", shape: "cube", sizeFeet: 15, affects: "all-creatures", pushFeetOnFailedSave: 10 }, description: "Aim a 15-foot cube through a selected creature. Each creature in it saves; failures and unsecured objects are pushed 10 feet, and the boom is audible to 300 feet.", provenance: { rulesetId: "dnd-2024", sourceId: "srd-5.2.1", sourceReference: "SRD 5.2.1, Thunderwave, p. 168" } },
  ],
