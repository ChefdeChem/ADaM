...
export const surinaDaardendrian: Character = {
  ...
  profile: {
    ...
    features: [
      ...
      { name: "Lay on Hands", description: "Spend points from a 5-point pool to heal by touch or spend 5 points to cure one disease or neutralize one poison. Feature activation is not implemented yet." },
    ],
  },
...
export const irvenWeber: Character = {
  ...
  spells: [
    ...
    { id: "searing-smite", name: "Searing Smite", level: 1, castingTime: "bonus-action", rangeFeet: 0, target: "self", requiresLineOfSight: false, damage: "1d6 fire", durationRounds: 10, description: "Empowers a hit and can ignite the target for repeated saves.", unsupportedReason: "Smite hit triggers, ongoing damage, and repeat saves are not implemented yet." },
    { id: "heroism", name: "Heroism", level: 1, castingTime: "action", rangeFeet: 5, target: "self-or-single", targetSide: "friendly", requiresLineOfSight: true, concentration: true, durationRounds: 10, description: "A touched creature is immune to fear and gains temporary hit points each turn.", unsupportedReason: "Fear immunity and recurring temporary hit points are not implemented yet." },
  ...
  profile: {
    ...
    features: [
      { name: "Lay On Hands", description: "Spend points from a 5-point pool as a bonus action to heal by touch, or spend 5 points to remove Poisoned. Feature activation is not implemented yet." },
...
export const pharos: Character = {
  ...
  spells: [
    { id: "chill-touch", name: "Chill Touch", level: 0, castingTime: "action", rangeFeet: 120, target: "single", targetSide: "hostile", requiresLineOfSight: true, attackBonus: 5, damage: "1d8 necrotic", durationRounds: 1, description: "A ranged spell attack deals necrotic damage and prevents healing until the start of the caster's next turn.", unsupportedReason: "Healing prevention and the undead attack-disadvantage rider are not implemented yet." },
    { id: "true-strike", name: "True Strike", level: 0, castingTime: "action", rangeFeet: 30, target: "self", requiresLineOfSight: false, concentration: true, durationRounds: 1, description: "Grants advantage on the first attack against a chosen target on the next turn.", unsupportedReason: "Delayed target-linked advantage is not implemented yet." },
    ...
    { id: "expeditious-retreat", name: "Expeditious Retreat", level: 1, castingTime: "bonus-action", rangeFeet: 0, target: "self", requiresLineOfSight: false, concentration: true, durationRounds: 100, description: "Allows Dash as a bonus action on each turn for up to 10 minutes.", unsupportedReason: "Recurring bonus-action Dash permission is not implemented yet." },
