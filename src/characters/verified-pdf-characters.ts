...
export const pharos: Character = {
  ...
  spells: [
    ...
    { id: "druidcraft", name: "Druidcraft", level: 0, castingTime: "action", rangeFeet: 30, target: "point", requiresLineOfSight: true, description: "Choose a weather sign, plant bloom, harmless sensory effect, or a small-flame interaction within 30 feet.", missingCapabilities: ["The specific weather prediction and player-authored sensory details remain descriptive."], utilityChoices: [
